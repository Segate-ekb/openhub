...
`10.0.0.0/8`. Негодная запись отвергается при чтении конфигурации с названной записью
и причиной; нечитаемая запись в цепочке оставляет адресом клиента адрес соединения
и объясняется на уровне ОТЛАДКА.
