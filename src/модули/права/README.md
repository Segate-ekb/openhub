...
| --- | --- | --- |
| `модель/` | ядро: действующее право как объединение всех его источников, запись и чтение точечных грантов, перевод «идентификатор ↔ логин или имя группы», правило «видит ли смотрящий этот объект права», учётка, стоящая за принципалом запроса | `/api/v1/pools/{пул}/grants` · раздел «Права доступа» |
...
| `github/` | ответы на вопросы «есть ли у человека право записи в этот репозиторий» и «чей это токен» и их реализации поверх GitHub REST | ещё один источник права, наравне с ролью и грантом · логин GitHub публикатора в журнале и уведомлениях |
