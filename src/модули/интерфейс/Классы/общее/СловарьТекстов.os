...
Процедура КлючиДомаПула()
	...
	Добавить("settings.pool.mirror-new.migrate.hint",
		"Для переезда: привезённые версии станут здесь СВОИМИ, как опубликованные в этом"
		+ " хабе. Среди них выбирается последняя, плашки «с апстрима» у них нет, а уборка"
		+ " места их не вытесняет. Даты у перенесённых версий — момент переноса, автор"
		+ " неизвестен. Включается только сейчас, при заведении: у наполненного зеркала"
		+ " перенос задним числом не появляется.");
