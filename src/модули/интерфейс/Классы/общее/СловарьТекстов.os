...
Процедура КлючиПровайдеровВхода()
	...
	Добавить("providers.geo.title", "Страны и доступ");
	...
	Добавить("providers.geo.notyet",
		"Правило сохраняется и правится, но пока никого не отсекает: хаб ещё не умеет"
		+ " определять страну посетителя.");
